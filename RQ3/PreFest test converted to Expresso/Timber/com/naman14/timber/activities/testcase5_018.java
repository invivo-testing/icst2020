...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Colored Navigation Bar\")", "new UiSelector().className(\"android.widget.TextView\").instance(13)")
        last = onView(withIndex(withText("Colored Navigation Bar"), 0));
