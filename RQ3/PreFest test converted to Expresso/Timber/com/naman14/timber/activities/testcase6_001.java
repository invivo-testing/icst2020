...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Heartbeat\")", "new UiSelector().className(\"android.widget.TextView\").instance(18)")
        last = onView(withIndex(withText("Heartbeat"), 0));
        ...
        last = onView(withIndex(withId(com.naman14.timber.R.id.search_src_text), 0));
        ...
        last = onView(allOf(isDisplayed(), isAssignableFrom(EditText.class)));
        try{ last = last.perform(typeText("Search Library")); }
        catch(NoMatchingViewException e1){System.err.println("Element not found, skipping event");}
        catch(PerformException e2){System.err.println("Element partially hidden, skipping event");};
