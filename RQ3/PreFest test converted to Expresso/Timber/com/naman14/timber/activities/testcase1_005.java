...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Shuffle All\")", "new UiSelector().className(\"android.widget.TextView\")")
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"com.naman14.timber:id/search_close_btn\").className(\"android.widget.ImageView\")")
        last = onView(withIndex(withId(com.naman14.timber.R.id.search_close_btn), 0));
