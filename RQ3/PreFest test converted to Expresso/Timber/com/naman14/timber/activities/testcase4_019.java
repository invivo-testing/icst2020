...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Test of MP3 File\")", "new UiSelector().className(\"android.widget.TextView\").instance(5)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Test of MP3 File\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
        last = onView(withIndex(withText("Test of MP3 File"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Add to queue\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Heartbeat\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
