...
public class TimePrinter {
    ...
    private static final TimePrinter timePrinter = new TimePrinter();
    private Integer counter = new Integer(0);
    private static File logFile = new File("/sdcard/Download/materialistic_nexus_5_android_4.4_api_19.csv");
