...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Blackbird Blackbird\")", "new UiSelector().className(\"android.widget.TextView\").instance(18)")
