...
public void test() throws InterruptedException {
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"com.naman14.timber:id/style_image\").className(\"android.widget.ImageView\")")
        last = onView(withIndex(withId(com.naman14.timber.R.id.style_image), 0));
