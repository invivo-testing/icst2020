...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Add to playlist\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"test\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
        last = onView(withIndex(withText("test"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Toggle status bar coloring\")", "new UiSelector().className(\"android.widget.TextView\").instance(12)")
        last = onView(withIndex(withText("Toggle status bar coloring"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Dark Theme\")", "new UiSelector().className(\"android.widget.TextView\").instance(5)")
        last = onView(withIndex(withText("Dark Theme"), 0));
	 ...
	 // TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"She\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
