...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Advanced\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
        last = onView(withIndex(withText("Advanced"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Playing queue support in notification\")", "new UiSelector().className(\"android.widget.TextView\").instance(7)")
        last = onView(withIndex(withText("Playing queue support in notification"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Restore previous purchases\")", "new UiSelector().className(\"android.widget.TextView\").instance(13)")
        last = onView(withIndex(withText("Restore previous purchases"), 0));
	 ...
	 // TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Load artist/album images on mobile data\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
        last = onView(withIndex(withText("Load artist/album images on mobile data"), 0));
