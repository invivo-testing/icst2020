...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Add to playlist\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        last = onView(withIndex(withText("Add to playlist"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Create new playlist\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
        last = onView(withIndex(withText("Create new playlist"), 0));
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"android:id/input\").className(\"android.widget.EditText\")")
        last = onView(withIndex(withId(android.R.id.input), 0));
        ...
        // 	element.send_keys("Enter playlist name");
        last = onView(allOf(isDisplayed(), isAssignableFrom(EditText.class)));
        try{ last = last.perform(typeText("Enter playlist name")); }
        catch(NoMatchingViewException e1){System.err.println("Element not found, skipping event");}
        catch(PerformException e2){System.err.println("Element partially hidden, skipping event");};

        // 	element = getElememtBack(driver, "new UiSelector().text(\"Create\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Me\")", "new UiSelector().className(\"android.widget.TextView\").instance(14)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"intermission\")", "new UiSelector().className(\"android.widget.TextView\").instance(11)")
        last = onView(withIndex(withText("intermission"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Test of MP3 File\")", "new UiSelector().className(\"android.widget.TextView\").instance(13)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Go to artist\")", "new UiSelector().className(\"android.widget.TextView\")")
