...
public void test() throws InterruptedException {
        ...
        last = onView(withIndex(withText("Artists"), 0));
        ...
        last = onView(withIndex(withText("Albums"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Me\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Songs\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
        last = onView(withIndex(withText("Songs"), 0));
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"com.naman14.timber:id/next\").className(\"android.widget.ImageView\")")
        last = onView(withIndex(withId(com.naman14.timber.R.id.next), 0));
