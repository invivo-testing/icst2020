...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Sort by\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"A-Z\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
        last = onView(withIndex(withText("A-Z"), 0));
