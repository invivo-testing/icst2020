...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"sdcard\")", "new UiSelector().className(\"android.widget.TextView\").instance(5)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Exit\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
        last = onView(withIndex(withText("Exit"), 0));
