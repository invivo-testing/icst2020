...
TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Pictures\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(5)")
        last = onView(withIndex(withText("Pictures"), 0));
