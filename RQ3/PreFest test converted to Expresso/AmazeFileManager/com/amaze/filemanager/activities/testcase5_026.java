...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Size\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        last = onView(withIndex(withText("Size"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Ascending\")", "new UiSelector().className(\"android.widget.TextView\").instance(5)")
        last = onView(withIndex(withText("Ascending"), 0));
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"com.amaze.filemanager:id/menu_new_folder\").className(\"android.widget.ImageButton\")")
        last = onView(withIndex(withId(com.amaze.filemanager.R.id.menu_new_folder), 0));
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"com.amaze.filemanager:id/singleedittext_input\").className(\"android.widget.EditText\")")
        last = onView(withIndex(withId(com.amaze.filemanager.R.id.singleedittext_input), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"CANCEL\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
