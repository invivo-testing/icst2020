...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"/storage/sdcard\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"com.amaze.filemanager:id/menu_new_file\").className(\"android.widget.ImageButton\")")
        last = onView(withIndex(withId(com.amaze.filemanager.R.id.menu_new_file), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Cloud Connection\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
        last = onView(withIndex(withText("Cloud Connection"), 0));
