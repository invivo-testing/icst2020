...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"sdcard\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        last = onView(withIndex(withText("sdcard"), 0));
        ...
        last = onView(withIndex(withId(com.amaze.filemanager.R.id.imageButton), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Music\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(4)")
        last = onView(withIndex(withText("Music"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Date\")", "new UiSelector().className(\"android.widget.TextView\").instance(7)")
        last = onView(withIndex(withText("Date"), 0));
