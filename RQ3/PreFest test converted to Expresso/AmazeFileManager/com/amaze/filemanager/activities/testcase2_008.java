...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Recent files\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(2)")
        last = onView(withIndex(withText("Recent files"), 0));
