...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Folder\")", "new UiSelector().className(\"android.widget.TextView\")")
        last = onView(withIndex(withText("Folder"), 0));
        ...
        // 	element.send_keys("Enter Name");
        last = onView(allOf(isDisplayed(), isAssignableFrom(EditText.class)));
        try{ last = last.perform(typeText("Enter Name")); }
        catch(NoMatchingViewException e1){System.err.println("Element not found, skipping event");}
        catch(PerformException e2){System.err.println("Element partially hidden, skipping event");};
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Clear\")", "new UiSelector().className(\"android.widget.TextView\").instance(11)")
        last = onView(withIndex(withText("Clear"), 0));
