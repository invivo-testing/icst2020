...
TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Movies\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(3)")
        last = onView(withIndex(withText("Movies"), 0));
        ...
        last = onView(withIndex(withText("items 0.00B"), 0));
