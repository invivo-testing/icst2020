...
public void test() throws InterruptedException {
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"com.amaze.filemanager:id/search_edit_text\").className(\"android.widget.EditText\")")
        last = onView(withIndex(withId(com.amaze.filemanager.R.id.search_edit_text), 0));
        ...
        // 	element.send_keys("Type to search.");
        last = onView(allOf(isDisplayed(), isAssignableFrom(EditText.class)));
        try{ last = last.perform(typeText("Type to search.")); }
        catch(NoMatchingViewException e1){System.err.println("Element not found, skipping event");}
        catch(PerformException e2){System.err.println("Element partially hidden, skipping event");};
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Only this folder\")", "new UiSelector().resourceId(\"com.amaze.filemanager:id/md_promptCheckbox\").className(\"android.widget.CheckBox\")")
        last = onView(withIndex(withText("Only this folder"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Type\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
        last = onView(withIndex(withText("Type"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Descending\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
        last = onView(withIndex(withText("Descending"), 0));
        ...
        last = onView(withIndex(withText("Grid View"), 0));
