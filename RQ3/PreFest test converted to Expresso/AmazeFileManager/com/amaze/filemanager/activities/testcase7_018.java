...
public void test() throws InterruptedException {
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"com.amaze.filemanager:id/ipET\").className(\"android.widget.EditText\")")
        last = onView(withIndex(withId(com.amaze.filemanager.R.id.ipET), 0));
