...
public void test() throws InterruptedException {
        ...
        last = onView(withIndex(withText("Extra large"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"1p\")", "new UiSelector().className(\"android.widget.TextView\").instance(22)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Share\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        last = onView(withIndex(withText("Share"), 0));
