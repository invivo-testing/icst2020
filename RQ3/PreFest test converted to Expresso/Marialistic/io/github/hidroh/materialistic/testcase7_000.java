...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Past year\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        last = onView(withIndex(withText("Past year"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Catch Up\")", "new UiSelector().className(\"android.widget.TextView\")")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"...\")", "new UiSelector().className(\"android.widget.TextView\").instance(20)")
        last = onView(withIndex(withText("..."), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"...\")", "new UiSelector().className(\"android.widget.TextView\").instance(14)")
        last = onView(withIndex(withText("..."), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"...\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        last = onView(withIndex(withText("..."), 0));
