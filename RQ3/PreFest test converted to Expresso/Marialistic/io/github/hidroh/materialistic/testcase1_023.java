...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"11h - javoscript\")", "new UiSelector().className(\"android.widget.TextView\").instance(27)")
        last = onView(withIndex(withText("11h - javoscript"), 0));
