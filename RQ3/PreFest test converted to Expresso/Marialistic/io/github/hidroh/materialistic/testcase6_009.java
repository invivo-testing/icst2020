...
public void test() throws InterruptedException {
	 ...
	 // TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Saved Stories\")", "new UiSelector().className(\"android.widget.TextView\").instance(6)")
        last = onView(withIndex(withText("Saved Stories"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"46\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
        last = onView(withIndex(withText("46"), 0));
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"io.github.hidroh.materialistic:id/bookmarked\").className(\"android.widget.ImageView\")")
        last = onView(withIndex(withId(io.github.hidroh.materialistic.R.id.bookmarked), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"128 pts\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        last = onView(withIndex(withText("128 pts"), 0));
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"io.github.hidroh.materialistic:id/comment\").className(\"android.widget.TextView\")")
        last = onView(withIndex(withId(io.github.hidroh.materialistic.R.id.comment), 0));
