...
public void test() throws InterruptedException {
        ...
        last = onView(withIndex(withText("Font"), 0));
        ...
        last = onView(withIndex(withText("Droid Serif"), 0));
        ...
        last = onView(withIndex(withText("Same"), 0));
        ...
        last = onView(withIndex(withText("Show as cards"), 0));
