...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Last updated 0 mins ago\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
        last = onView(withIndex(withText("Last updated 0 mins ago"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Saved Stories\")", "new UiSelector().className(\"android.widget.TextView\")")
        last = onView(withIndex(withText("Saved Stories"), 0));
