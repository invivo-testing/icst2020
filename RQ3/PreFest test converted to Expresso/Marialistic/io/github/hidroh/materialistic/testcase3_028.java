...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Past year\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
        last = onView(withIndex(withText("Past year"), 0));
        ...
        last = onView(withIndex(withText("Comments"), 0));
        ...
        last = onView(withIndex(withText("Text size"), 0));
        ...
        last = onView(withIndex(withText("Roboto Slab"), 0));
        ...
        last = onView(withIndex(withText("Large"), 0));
