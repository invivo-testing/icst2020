...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"More sections\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Feedback\")", "new UiSelector().className(\"android.widget.TextView\").instance(7)")
