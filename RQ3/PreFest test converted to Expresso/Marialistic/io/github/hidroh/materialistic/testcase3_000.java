...
public void test() throws InterruptedException {
	 ...
	 // TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        // 	element = getElememt(driver, "new UiSelector().resourceId(\"io.github.hidroh.materialistic:id/menu_external\").className(\"android.widget.TextView\")")
        last = onView(withIndex(withId(io.github.hidroh.materialistic.R.id.menu_external), 0));
