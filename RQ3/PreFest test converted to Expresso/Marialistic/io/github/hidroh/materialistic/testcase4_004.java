...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"news.ycombinator.com\")", "new UiSelector().className(\"android.widget.TextView\").instance(18)")
        last = onView(withIndex(withText("news.ycombinator.com"), 0));
