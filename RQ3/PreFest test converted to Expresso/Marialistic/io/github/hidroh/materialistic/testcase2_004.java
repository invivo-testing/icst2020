...
public void test() throws InterruptedException {
	 ...
	 // TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"...\")", "new UiSelector().className(\"android.widget.TextView\").instance(2)")
        last = onView(withIndex(withText("..."), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"1p\")", "new UiSelector().className(\"android.widget.TextView\").instance(24)")
        last = onView(withIndex(withText("1p"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"...\")", "new UiSelector().className(\"android.widget.TextView\").instance(11)")
        last = onView(withIndex(withText("..."), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"...\")", "new UiSelector().className(\"android.widget.TextView\").instance(32)")
        last = onView(withIndex(withText("..."), 0));
