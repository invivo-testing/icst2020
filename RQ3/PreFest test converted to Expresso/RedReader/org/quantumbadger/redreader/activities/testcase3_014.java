...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"blog\")", "new UiSelector().className(\"android.widget.TextView\").instance(11)")
        last = onView(withIndex(withText("blog"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Copy Link\")", "new UiSelector().className(\"android.widget.TextView\")")
        last = onView(withIndex(withText("Copy Link"), 0));
        ...
        // 	element = getElememt(driver, "new UiSelector().className(\"android.widget.TextView\").description(\"Refresh Subreddits\")")
        last = onView(withIndex(withContentDescription("Refresh Subreddits"), 0));
