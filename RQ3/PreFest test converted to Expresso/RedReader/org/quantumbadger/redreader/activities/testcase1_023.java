...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"askscience\")", "new UiSelector().className(\"android.widget.TextView\").instance(9)")
        last = onView(withIndex(withText("askscience"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Themes\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        last = onView(withIndex(withText("Themes"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"/r/askreddit\")", "new UiSelector().className(\"android.widget.TextView\")")
        last = onView(withIndex(withText("/r/askreddit"), 0));
