...
public void test() throws InterruptedException {
        ...
        last = onView(withIndex(withText("Graphs"), 0));
	 ...
	 // TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Provide the custom SimpleDateFormat string to be used\")", "new UiSelector().className(\"android.widget.TextView\").instance(13)")
        last = onView(withIndex(withText("Provide the custom SimpleDateFormat string to be used"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Show temperature only as an integer\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
        last = onView(withIndex(withText("Show temperature only as an integer"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"12 h\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
        last = onView(withIndex(withText("12 h"), 0));
