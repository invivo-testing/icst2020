...
public void test() throws InterruptedException {
        ...
        // 	element = getElememt(driver, "new UiSelector().className(\"android.widget.CheckBox\").instance(4)")
        last = onView(withIndex(allOf(isDisplayed(), isAssignableFrom(android.widget.CheckBox.class)),0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"in Hg\")", "new UiSelector().className(\"android.widget.TextView\").instance(10)")
        last = onView(withIndex(withText("in Hg"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Display\")", "new UiSelector().className(\"android.widget.TextView\").instance(15)")
        last = onView(withIndex(withText("Display"), 0));
