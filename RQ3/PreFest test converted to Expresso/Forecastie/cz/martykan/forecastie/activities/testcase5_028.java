...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"None\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"30 min\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(2)")
        last = onView(withIndex(withText("30 min"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Display decimal zeroes\")", "new UiSelector().className(\"android.widget.TextView\").instance(4)")
        last = onView(withIndex(withText("Display decimal zeroes"), 0));
