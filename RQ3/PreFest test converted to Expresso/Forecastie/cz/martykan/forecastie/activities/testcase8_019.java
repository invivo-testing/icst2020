...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"kPa\")", "new UiSelector().className(\"android.widget.TextView\").instance(10)")
        last = onView(withIndex(withText("kPa"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"mm Hg\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(2)")
        last = onView(withIndex(withText("mm Hg"), 0));
	 ...
	 // TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Units\")", "new UiSelector().className(\"android.widget.TextView\").instance(1)")
        last = onView(withIndex(withText("Units"), 0));
