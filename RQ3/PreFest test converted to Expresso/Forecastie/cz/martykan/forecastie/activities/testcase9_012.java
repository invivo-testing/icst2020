...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Custom Date Format:12\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(4)")
        last = onView(withIndex(withText("Custom Date Format:12"), 0));
