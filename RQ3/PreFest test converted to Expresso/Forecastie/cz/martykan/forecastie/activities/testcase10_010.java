...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Custom Date Format\")", "new UiSelector().className(\"android.widget.TextView\").instance(13)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Celsius\")", "new UiSelector().className(\"android.widget.CheckedTextView\")")
        ...
        // 	element = getElememt(driver, "new UiSelector().className(\"android.widget.CheckBox\").instance(1)")
