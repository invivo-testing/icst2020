...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Fahrenheit\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        last = onView(withIndex(withText("Fahrenheit"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Abbreviations\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(2)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Fahrenheit\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(1)")
        last = onView(withIndex(withText("Fahrenheit"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"2 h\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
        last = onView(withIndex(withText("2 h"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"2 h\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(4)")
        last = onView(withIndex(withText("2 h"), 0));
