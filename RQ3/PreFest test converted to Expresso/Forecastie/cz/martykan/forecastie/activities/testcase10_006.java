...
public void test() throws InterruptedException {
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"API key\")", "new UiSelector().className(\"android.widget.TextView\").instance(9)")
        last = onView(withIndex(withText("API key"), 0));
        ...
        last = onView(withIndex(withId(android.R.id.edit), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Provide the custom SimpleDateFormat string to be used\")", "new UiSelector().className(\"android.widget.TextView\").instance(14)")
