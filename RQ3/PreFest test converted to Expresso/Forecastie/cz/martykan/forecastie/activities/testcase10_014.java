...
public void test() throws InterruptedException {
        ...
        last = onView(withIndex(allOf(isDisplayed(), isAssignableFrom(android.widget.EditText.class)),0));
        ...
        last = onView(withIndex(withText("There is a problem with your internet connection."), 0));
