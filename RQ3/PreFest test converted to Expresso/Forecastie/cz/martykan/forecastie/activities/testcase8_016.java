...
public void test() throws InterruptedException {
        ...
        last = onView(withIndex(withText("Tomorrow"), 0));
        ...
        last = onView(withIndex(withId(cz.martykan.forecastie.R.id.action_search), 0));
	 ...
	 // TimePrinter.getInstance().log("" + getClass().getName() + ", " + (testFinishTime-testStartTime));
        ...
        last = onView(withIndex(withText("Today"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Pressure units\")", "new UiSelector().className(\"android.widget.TextView\").instance(9)")
        last = onView(withIndex(withText("Pressure units"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Thu 01/14/2016 - 09:00 PM\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(2)")
        last = onView(withIndex(withText("Thu 01/14/2016 - 09:00 PM"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Kelvin\")", "new UiSelector().className(\"android.widget.TextView\").instance(3)")
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Arrows\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(1)")
        last = onView(withIndex(withText("Arrows"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"6 h\")", "new UiSelector().className(\"android.widget.TextView\").instance(8)")
        last = onView(withIndex(withText("6 h"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"1 h\")", "new UiSelector().className(\"android.widget.CheckedTextView\").instance(3)")
        last = onView(withIndex(withText("1 h"), 0));
        ...
        // 	element = getElememtBack(driver, "new UiSelector().text(\"Custom API key for OpenWeatherMap queries\")", "new UiSelector().className(\"android.widget.TextView\").instance(10)")
        last = onView(withIndex(withText("Custom API key for OpenWeatherMap queries"), 0));
